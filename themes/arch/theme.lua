...
theme.panel_height = 32 -- panel height
...
------------------------------------------------------------
theme.fonts = {
    main = "Noto Sans Regular 10",           -- main font
    menu = "Noto Sans Regular 10",           -- main menu font
    tooltip = "Noto Sans Regular 10",        -- tooltip font
    notify = "Noto Sans Mono Regular 10",    -- redflat notify popup font
    clock = "Noto Sans Mono Regular 10",     -- textclock widget font
    qlaunch = "Noto Sans Mono Regular 10",   -- quick launch key label font
    title = "Noto Sans Mono Regular 10",     -- widget titles font
    tiny = "Noto Sans Mono Regular 10",      -- smallest font for widgets
    keychain = "Noto Sans Mono Regular 10",  -- key sequence tip font
    titlebar = "Noto Sans Mono Regular 10",  -- client titlebar font
    logout = {
        label = "Noto Sans Mono Regular 10", -- logout option labels
        counter = "Noto Sans Mono Bold 14"   -- logout counter
    },
    hotkeys = {
        main = "Noto Sans Mono Regular 10", -- hotkeys helper main font
        key = "Noto Sans Mono Bold 9",      -- hotkeys helper key font (use monospace for align)
        title = "Noto Sans Mono Regular 10" -- hotkeys helper group title font
    },
    player = {
        main = "Noto Sans Mono Bold 9",    -- player widget main font
        time = "Noto Sans Mono Regular 10" -- player widget current time font
    },
    -- very custom calendar fonts
    calendar = {
        clock = "Sans 12",
        date = "Sans 11",
        week_numbers = "Noto Sans Regular 10",
        weekdays_header = "Sans 9",
        days = "Sans 9",
        default = "Sans 8",
        focus = "Noto Sans Regular 10 Bold",
        controls = "Sans 11"
    }
}
...
function theme:init()
    ...
    self.service.dfparser = {
        ...
        -- icon theme settings
        icons = {
            theme = nil,                -- user icon theme path = "/usr/share/icons/ACYLS"
    ...
    self.gauge.tag.blue = {
        ...
        point = {
            ...
            gap = 16,   -- shift from upper border of widget to apps indicator
    ...
    theme.desktop.speedmeter.normal = {
        ...
        color = {
            wibox = "transparent",
            gray = theme.color.desktop_widget
        },
        -- progressbar = {
        --     chunk = {
        --         width = 3,
    ...
    -- Multilines cores (individual widget)
    theme.individual.desktop.multiline.cores = {
        digits = 1,
        unit = { { "%", -1 } },
        lines = {
            show = {
