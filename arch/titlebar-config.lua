...
function titlebar:init()
    ...
    -- titlebar schemes
    style.base = redutil.table.merge(redutil.table.check(beautiful, "titlebar.base") or {}, {
        size = 8
    })
    style.iconic = redutil.table.merge(style.base, {
        size = 24
    })

    -- titlebar elements styles
    style.mark_mini = redutil.table.merge(redutil.table.check(beautiful, "titlebar.mark") or {}, {
        size = 30,
        gap = 10,
        angle = 0
    })
    style.icon = redutil.table.merge(redutil.table.check(beautiful, "titlebar.icon") or {}, {
        gap = 10
    })
