    ...
    pack = {
        {
            ...
            {"Control"}, "a", nil,
            {
                description = "Go to the start of the command line",
                group = "Editing"
            }
        }, {
            {"Control"}, "e", nil,
            {
                description = "Go to the end of the command line",
                group = "Editing"
            }
        }, {
            {"Control"}, "k", nil, {
                description = "Delete from cursor to the end of the command line",
                group = "Editing"
            }
        }, {
            {"Control"}, "u", nil, {
                description = "Delete from cursor to the start of the command line",
                group = "Editing"
            }
        }, {
            {"Control"}, "w", nil,
            {
                description = "Delete from cursor to start of word ",
                group = "Editing"
            }
        }, {
            {"Control"}, "y", nil,
            ...
            {"Control"}, "xx", nil, {
                description = "Move between start of command line and cursor",
                group = "Editing"
            }
        }, {
            {"Alt"}, "b", nil,
        ...
        },
        {
            ...
            {"Alt"}, "d", nil,
            {
                description = "Delete to end of word starting at cursor",
                group = "Editing"
            }
        }, {
            {"Alt"}, "c", nil, {
                description = "Capitalize to end of word starting at cursor",
                group = "Editing"
            }
        }, {
            {"Alt"}, "u", nil,
            {
                description = "Make uppercase from cursor to end of word",
                group = "Editing"
            }
        }, {
            {"Alt"}, "l", nil,
            {
                description = "Make lowercase from cursor to end of word",
                group = "Editing"
            }
        }, {
            {"Alt"}, "t", nil,
            ...
            {"Control"}, "d", nil,
            {
                description = "Delete character under the cursor",
                group = "Editing"
            }
        }, {
            {"Control"}, "h", nil,
            ...
            {"Control"}, "t", nil, {
                description = "Swap character under cursor with the previous one",
                group = "Editing"
            }
        }, {
            {"Control"}, "r", nil,
            ...
            {"Control"}, "g", nil,
            {
                description = "Escape from history searching mode",
                group = "Recall"
            }
        }, {
            {"Control"}, "p", nil,
            ...
            {"Alt"}, ".", nil,
            {
                description = "Use the last word of the previous command",
                group = "Recall"
            }
        }, {{}, "!!", nil, {description = "Run last command", group = "Bang"}},
        {
            {}, "!blah", nil, {
                description = "Run the most recent command that starts with ‘blah’",
                group = "Bang"
            }
        }, {
            {}, "!blah:p", nil,
            {
                description = "Print out the command that !blah would run",
                group = "Bang"
            }
        }, {
            {}, "!$", nil,
            {
                description = "The last word of the previous command",
                group = "Bang"
            }
        }, {
            {}, "!$:p", nil,
            {
                description = "Print out the word that !$ would substitute",
                group = "Bang"
            }
        }, {
            {}, "!*", nil,
            {
                description = "The previous command except for the last word",
                group = "Bang"
            }
        }, {
            {}, "!*:p", nil,
...
appkeys["mpv"] = {
    ...
    pack = {
        ...
        {{}, "s", nil, {description = "Take a screenshot", group = "General"}},
        {
            {"Shift"}, "s", nil,
            {
                description = "Take a screenshot without subtitles",
                group = "General"
            }
        ...
        }, {{}, "o", nil, {description = "Show progress", group = "General"}},
        {
            ...
            {}, "F9", nil,
            {
                description = "Show the list of audio and subtitle",
                group = "General"
            }
        },
        {
        ...
        {{}, "9", nil, {description = "Decrease volume", group = "Audio"}},
        {{}, "0", nil, {description = "Increase volume", group = "Audio"}}, {
            {"Control"}, "-", nil,
