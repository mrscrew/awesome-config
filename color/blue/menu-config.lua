...
function menu:init(args)
	...
	------------------------------------------------------------
	local awesomemenu = {
		{ "Перезагрузка",         awesome.restart,                 micon("gnome-session-reboot") },
		separator,
		{ "конфигурация Awesome",  env.fm .. " .config/awesome",        micon("folder-bookmarks") },
		{ "библиотека Awesome",     env.fm .. " /usr/share/awesome/lib", micon("folder-bookmarks") }
	}
	...
	local exitmenu = {
		...
		separator,
		{ "Переключить пользователя",     "dm-tool switch-to-greeter", micon("gnome-session-switch")  },
